...
import com.example.myapplication.databinding.FragmentLoseBinding;
...
public class LoseFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        CalculationViewModel calculationViewModel = new ViewModelProvider(requireActivity(),new SavedStateViewModelFactory(requireActivity().getApplication(),this)).get(CalculationViewModel.class);
